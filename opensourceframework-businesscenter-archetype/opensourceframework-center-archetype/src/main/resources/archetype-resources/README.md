    ...
    工程总体结构如下图示，通常会包含api、biz、boot等三个核心子模块:
            ...
            2.1 包结构:
                |-- ${package}.biz
                    ...
                    |-- service	
                        |-- impl
                            ...
                            |-- XxxxTwoServiceImpl.java
                            |-- ...
                        |-- IXxxxService.java
                        |-- IXxxxTwoService.java
                        |-- ...
                    |-- dao		
                        |-- eo
                            |-- XxxxOneEo.java 实体类
                            ...
                            |-- ..............    
                        |-- mapper
                            |-- XxxxMapper.java  mybatis mapper  
                            |-- ...............    
                        |-- repository
                            |-- XxxxDao.java   为简化Dao层,无需编写接口类  
                            |-- ................                          
                    |-- mq (optional)
                        |-- constants  常量
                        |-- handler    消息处理
                ...
                |-- ${package}.biz
                    ...
                    |-- service	
                        ...
                        |-- bbbb
                            |-- impl
                                |-- BbbbServiceImpl.java
                                |-- BbbbTwoServiceImpl.java
                                |-- ...
                            |-- IBbbbService.java
                            |-- IBbbbTwoService.java
                            |-- ...
                    |-- dao		
                        |-- eo
                            |-- aaaa子业务包名
                ...
                |-- reources
                    |-- com.opensourceframework.center.${bizName}.mybatis.mapper
                        |-- xxx.xml
                资源文件夹 resources (optional),存放 mybatis mapper 映射xml文件 
                存放路径与${rootArtifactId}-boot模块中bootstrap.yml的mybatis.mapperLocations值对应，也可配置在nacos中的dataId:${rootArtifactId}.properties中
                例如:
                # ${rootArtifactId}-boot/resources/bootstrap.yml
                mybatis:
                    #指定mybatis xml映射文件的资源路径 多个,隔开
                    mapperLocations: classpath*:com/opensourceframework/center/${bizName}/mybatis/mapper/*.xml
                    #指定mybatis 类型别名
                    typeAliasesPackage:
                    #指定mybatis 配置文件的资源路径
                    configLocation:
        ...
        3.${rootArtifactId}-boot模块工程结构:
            ...
            3.2 resources说明
               |-- resources
                   |-- META-INF(optional)
                      |-- spring.factories   starter-autoconfig文件
...
${md_file_char} Nacos配置说明
    ...
    2、业务域中心服务配置(数据库、MQ-topic等非通用配置)
