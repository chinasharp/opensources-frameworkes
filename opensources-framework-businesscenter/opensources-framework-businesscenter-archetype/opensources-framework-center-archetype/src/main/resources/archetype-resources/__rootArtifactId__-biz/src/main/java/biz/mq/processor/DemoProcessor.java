...
import ${groupId}.common.rest.MessageResponse;
import ${groupId}.common.vo.MessageVo;
import ${groupId}.framework.log.LoggerFactory;
import ${groupId}.mq.annotation.MQSubscribe;
import ${groupId}.mq.api.IMessageProcessor;
 ...
 */
@Component
@MQSubscribe(topic = "${symbol_dollar}{mq.demouser.subscribe.registryvo.topic}", tag = "${symbol_dollar}{mq.demouser.subscribe.registryvo.tag}" ,
		consumer = "${symbol_dollar}{mq.demouser.subscribe.registryvo.consumer}")
