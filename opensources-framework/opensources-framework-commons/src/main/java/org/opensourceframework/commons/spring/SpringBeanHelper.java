package org.opensourceframework.commons.spring;
...
public class SpringBeanHelper implements ApplicationContextAware {
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ...
        if (SpringBeanHelper.applicationContext != null) {
            logger.warn("SpringContextHolder中的ApplicationContext被覆盖, 原有ApplicationContext为:{}",SpringBeanHelper.applicationContext);
        }
