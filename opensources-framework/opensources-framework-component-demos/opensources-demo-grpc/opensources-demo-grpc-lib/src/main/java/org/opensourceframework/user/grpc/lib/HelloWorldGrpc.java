...
public final class HelloWorldGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldRequest,
      org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldRequest.class,
      responseType = org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldRequest,
      org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldRequest, org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldReply> getSayHelloMethod;
      ...
      synchronized (HelloWorldGrpc.class) {
        if ((getSayHelloMethod = HelloWorldGrpc.getSayHelloMethod) == null) {
          HelloWorldGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldRequest, org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldReply.getDefaultInstance()))
  ...
  public static abstract class HelloWorldImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldRequest request,
        io.grpc.stub.StreamObserver<org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldRequest,
                org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldReply>(
  ...
  public static final class HelloWorldBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloWorldBlockingStub> {
    ...
    /**
     */
    public org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldReply sayHello(org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldRequest request) {
  ...
  public static final class HelloWorldFutureStub extends io.grpc.stub.AbstractFutureStub<HelloWorldFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldReply> sayHello(
        org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldRequest) request,
              (io.grpc.stub.StreamObserver<org.opensourceframework.user.grpc.lib.Helloworld.HelloWorldReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.opensourceframework.user.grpc.lib.Helloworld.getDescriptor();
    }
