package org.opensourceframework.canal.adapter.demo.boot.config.opensourceframework_order;
...
@ESDocument(table = "order_member_info", index = "order_member_info", isHumpCol = true,
        destination = "CANAL_ORDER_TOPIC", groupId = "opensourceframework_order",
        dataSourceKey = "opensourceframework_order", outerAdapterKey = "opensourceframework_order")
