...
public class BusinessServiceImpl implements BusinessService{
    ...
    @DubboReference(group = "opensources-user-storage", version = "1.0.0", protocol = "dubbo",check = false,timeout = 60000)
    private StorageDubboService storageDubboService;

    @DubboReference(group = "opensources-user-order", version = "1.0.0", protocol = "dubbo",check = false,timeout = 60000)
