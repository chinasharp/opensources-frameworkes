package org.opensourceframework.demo.es.eo;
 ...
 * @since 1.0.0
 * @date  2021/4/25 下午6:39
 */
@ESDocument(index = "order_record_to_telemarket")
public class OrderRecordToTelemarketEo extends BaseEsEo {
	...
	@ESField(column = "discountFee", type = "scaled_float", scalingFactor = 1000)
	...
	@ESField(column = "salePayAmount", type = "scaled_float", scalingFactor = 1000)
	...
	@ESField(column = "remissionDeposit", type = "scaled_float", scalingFactor = 1000)
	...
	public OrderRecordToTelemarketEo() {
	}
