package org.opensourceframework.demo.mq.transaction.dto.request.user;
 ...
 *
 */
@ApiModel(value = "DemoUserReqDto",description = "Demo user 请求参数对象")
public class DemoUserReqDto extends BaseDto {
