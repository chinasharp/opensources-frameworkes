...
/**
 * Deflater压缩，Inflater解压
 *
 * @author yu.ce@foxmail.com
 * @date 2021-09-24 16:16
 * @since 1.0.0
 */
public class ZipTextHelper {
    /**
     * 压缩
     */
    public static String zip(String unzipString) {
        /*
         *     0 ~ 9 压缩等级 低到高
     ...
     * 解压缩
     */
    public static String unzip(String zipString) {
