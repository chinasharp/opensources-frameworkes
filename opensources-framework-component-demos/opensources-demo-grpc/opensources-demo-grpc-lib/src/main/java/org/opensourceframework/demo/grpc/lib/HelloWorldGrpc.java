package org.opensourceframework.demo.grpc.lib;
...
public final class HelloWorldGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Helloworld.HelloWorldRequest, Helloworld.HelloWorldReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = Helloworld.HelloWorldRequest.class,
      responseType = Helloworld.HelloWorldReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Helloworld.HelloWorldRequest, Helloworld.HelloWorldReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<Helloworld.HelloWorldRequest, Helloworld.HelloWorldReply> getSayHelloMethod;
      ...
      synchronized (HelloWorldGrpc.class) {
        if ((getSayHelloMethod = HelloWorldGrpc.getSayHelloMethod) == null) {
          HelloWorldGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<Helloworld.HelloWorldRequest, Helloworld.HelloWorldReply>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Helloworld.HelloWorldReply.getDefaultInstance()))
  ...
  public static abstract class HelloWorldImplBase implements io.grpc.BindableService {
    ...
    public void sayHello(Helloworld.HelloWorldRequest request,
                         io.grpc.stub.StreamObserver<Helloworld.HelloWorldReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            getSayHelloMethod(),
            asyncUnaryCall(
              new MethodHandlers<Helloworld.HelloWorldRequest, Helloworld.HelloWorldReply>(
  ...
  public static final class HelloWorldBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloWorldBlockingStub> {
    ...
    /**
     */
    public Helloworld.HelloWorldReply sayHello(Helloworld.HelloWorldRequest request) {
  ...
  public static final class HelloWorldFutureStub extends io.grpc.stub.AbstractFutureStub<HelloWorldFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Helloworld.HelloWorldReply> sayHello(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((Helloworld.HelloWorldRequest) request,
              (io.grpc.stub.StreamObserver<Helloworld.HelloWorldReply>) responseObserver);
          break;
        default:
